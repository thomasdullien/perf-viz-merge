...
enum class PerfEventType : uint8_t {
    ...
    NvidiaLaunchReturn,
    NvidiaStreamSync,
    NvidiaStreamSyncReturn,
    NvidiaDeviceSync,
    NvidiaDeviceSyncReturn,
    NvidiaEventSync,
    NvidiaEventSyncReturn,
    NvidiaMemcpyHtoD,
    NvidiaMemcpyHtoDReturn,
    NvidiaMemcpyDtoH,
    NvidiaMemcpyDtoHReturn,
    NvidiaMemcpyDtoD,
    NvidiaMemcpyDtoDReturn,
    NvidiaMemcpyAsync,
    NvidiaMemcpyAsyncReturn,
    NvidiaMalloc,
    NvidiaMallocReturn,
    NvidiaFree,
    NvidiaFreeReturn,
    NvidiaMemcpyPeer,
    NvidiaMemcpyPeerReturn,
    // NCCL events
    NcclAllReduce,
    NcclAllReduceReturn,
    NcclBroadcast,
